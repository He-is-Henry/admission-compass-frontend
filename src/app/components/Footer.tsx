        ...
        <div className={styles.grid}>
          <div>
            ...
            <div className={styles.socials}>
              <Link
                href="https://www.instagram.com/admission_compass_?igsh=bmpsa2Nhd205dGRm"
              ...
              <Link
                href="https://whatsapp.com/channel/0029VbBV0juGU3BFYFyvon2l"
                className={styles.socialLink}
                aria-label="Follow the Admission Compass channel on WhatsApp"
              >
                <svg
                  className={styles.icon}
                  fill="currentColor"
              ...
              <Link
                href="https://www.facebook.com/profile.php?id=61578450807337"
                className={styles.socialLink}
